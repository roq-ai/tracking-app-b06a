...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiTrash2, FiBriefcase } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'facility-manager', 'cleaning-staff', 'asset-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Asset', path: '/assets', entity: 'asset', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Cleanup', path: '/cleanups', entity: 'cleanup', service: AccessServiceEnum.PROJECT, icon: FiTrash2 },
    { name: 'Facility', path: '/facilities', entity: 'facility', service: AccessServiceEnum.PROJECT, icon: FiBox },
